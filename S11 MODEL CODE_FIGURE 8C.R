...
# PLOTTING RT_1, RT_2, RT_TOT, RT_HAT ON LEFT AXIS AND POLICY_KAPPA_RT ON RIGHT AXIS
...
# SAVING THE PLOT
ggsave("policy_kappa_rt.png", width = 20, height = 6, dpi = 300)
print("Plot has been saved as policy_kappa_rt.png")