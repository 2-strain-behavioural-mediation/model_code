...
parameters_1 <- c(
  ...
  start_I2 = 0 # START OF VARIANT 2 TRANSMISSION
)
...
ggplot(out_long, aes(x = time, y = value, color = variable)) +
  ...
  labs(x = "Time", title = "Pronounced Effect of Variant 2 on Variant 1 with Behavioural Mediation") +
  theme_minimal() +
  theme(
...
# SAVING THE PLOT
ggsave("variant_prevalence_plot_2.png", width = 20, height = 6, dpi = 300)
print("Plot has been saved as variant_prevalence_plot_2.png")