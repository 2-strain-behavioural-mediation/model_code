...
ggplot(out_long, aes(x = time, y = value, color = variable)) +
  ...
  labs(x = "Time", title = "No Behavioural Mediation, Variant 2 Starts on Day 10") +
  theme_minimal() +
  theme(
...
# SAVING THE PLOT
ggsave("variant_prevalence_plot_4.png", width = 20, height = 6, dpi = 300)
print("Plot has been saved as variant_prevalence_plot_4.png")