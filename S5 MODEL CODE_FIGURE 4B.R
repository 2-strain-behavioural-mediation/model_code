...
ggplot(out_long, aes(x = time, y = value, color = variable)) +
  ...
  labs(x = "Time", title = "Pronounced Effect of Variant 1 on Variant 2 with Behavioural Mediation") +
  theme_minimal() +
  theme(
...
# SAVING THE PLOT
ggsave("variant_prevalence_plot_5.png", width = 20, height = 6, dpi = 300)
print("Plot has been saved as variant_prevalence_plot_5.png")